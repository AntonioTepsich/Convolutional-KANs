...
get_best_model(KANC_MLP_Big,epochs=20,config = {'lr': 0.0005, 'weight_decay': 1e-05, 'batch_size': 128}, train_obj= mnist_train,test_loader= mnist_test,path ="models\FashionMNIST" ,is_kan= True,grid_size = 20)
