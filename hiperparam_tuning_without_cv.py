...
search_hiperparams_and_get_final_model(KANC_MLP,True, mnist_train,  test_loader,max_epochs= 1,path = path,search_grid_combinations = 10 ,folds = 1,dataset_name=dataset_name)
